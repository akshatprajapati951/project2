...
public class ServletUtility {
	...
	public static void forwardView(String page, HttpServletRequest request, HttpServletResponse response)
		...
		RequestDispatcher rd = request.getRequestDispatcher(ORSView.JAVA_DOC_VIEW);
		rd.forward(request, response);
	}
	...
	/**
	 * Sets Total Record of Table
	 * 
	 * @param record
	 * @param request
	 */
	public static void setRecord(int record, HttpServletRequest request) {
		request.setAttribute("record", record);
	}

	/**
	 * Gets Total Record of Table
	 * 
	 * @param record
	 * @param request
	 */
	public static int getRecord(HttpServletRequest request) {
		int i = (Integer) request.getAttribute("record");
		return i;
	}
	...
	public static int getPageSize(HttpServletRequest request) {
		int i = (Integer) request.getAttribute("pageSize");
		return i;
	}

	...
	public List getMeritList(int pageNo, int pageSize) throws ApplicationException {
		...
		try {
			...
			StringBuffer hql = new StringBuffer(
					"from MarksheetDTO where physics>33 and chemistry>33 and maths>33 order by (chemistry + maths + physics) desc");
			...
			/*
			 * session = HibDataSource.getSession(); // String sql = "SELECT
			 * `ROLLNO`, `NAME`, `PHYSICS`, `CHEMISTRY`, // `MATHS` , (PHYSICS +
			 * CHEMISTRY + MATHS) as total from // `ST_MARKSHEET` where maths
			 * >=33 && physics>= 33 && chemistry>= 33 // order by total desc";
			 * String sql =
			 * "SELECT rollno,name,chemistry,maths,physics, (chemistry + maths + physics) as total from st_Marksheet where chemistry >33 && maths >33 && physics >33 ORDER BY total DESC LIMIT 0,10"
			 * ;
			 * 
			 * SQLQuery query = session.createSQLQuery(sql);
			 * 
			 * query.addEntity(MarksheetDTO.class);
			 * 

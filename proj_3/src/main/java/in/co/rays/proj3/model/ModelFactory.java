...
public final class ModelFactory {
	...
	public MarksheetModelInt getMarksheetModel() {
		...
		if (marksheetModel == null) {
			...
			/*
			 * if ("JDBC".equals(DATABASE)) { marksheetModel = new
			 * MarksheetModelJDBCImpl(); }
			 */
	...
	public UserModelInt getUserModel() {
		...
		if (userModel == null) {
			...
			/*
			 * if ("JDBC".equals(DATABASE)) { userModel = new
			 * UserModelJDBCImpl(); }
			 */
	...
	public CollegeModelInt getCollegeModel() {
		...
		if (collegeModel == null) {
			...
			/*
			 * if ("JDBC".equals(DATABASE)) { collegeModel = new
	...
	public StudentModelInt getStudentModel() {
		...
		if (studentModel == null) {
			...
			/*
			 * if ("JDBC".equals(DATABASE)) { studentModel = new
			 * StudentModelJDBCImpl(); }
			 */
	...
	public RoleModelInt getRoleModel() {
		...
		if (roleModel == null) {
			...
			/*
			 * if ("JDBC".equals(DATABASE)) { roleModel = new
			 * RoleModelJDBCImpl(); }
			 */
	...
	public CourseModelInt getCourseModel() {
		...
		if (courseModel == null) {
			...
			/*
			 * if("JDBC".equals(DATABASE)){ courseModel=new
			 * CourseModelJDBCImpl(); }
			 */
	...
	public SubjectModelInt getSubjectModel() {
		...
		if (subjectModel == null) {
			...
			/*
			 * if("JDBC".equals(DATABASE)){ subjectModel=new
			 * SubjectModelJDBCImpl(); }
			 */
	...
	public FacultyModelInt getFacultyModel() {
		...
		if (facultyModel == null) {
			...
			/*
			 * if("JDBC".equals(DATABASE)){ facultyModel=new
	...
	public TimeTableModelInt getTimeTableModel() {
		...
		if (timetableModel == null) {
			...
			/*
			 * if("JDBC".equals(DATABASE)){ timetableModel=new
			 * TimeTableModelJDBCImpl(); }
			 */

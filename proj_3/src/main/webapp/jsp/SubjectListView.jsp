...
<section class="content">
  <form action="<%=ORSView.SUBJECT_LIST_CTL%>" method="post">
	<jsp:useBean id="dto"
					class="in.co.rays.proj3.dto.SubjectDTO" scope="request"></jsp:useBean>
			...
			<h3 align="center">
				...
				<div class="card-body" style="text-align: center;">
					<div class="form-group">
						...
						style="text-align: left;">Subject Name</label>
							<div class="col-md-3">
								<%=HtmlUtility.getList("id", String.valueOf(dto.getId()), l1)%>
							</div>
							&emsp;
							<label for="courseId" class="col-md-0 mb-2"
			...
			<thead>
					...
					<tr align="center">
						...
						<td>
							<%
								if (RoleDTO.ADMIN == userBean.getRoleId()) {
							%><a href="SubjectCtl?id=<%=bean1.getId()%>">Edit</a> <%
 	}
 %>
						</td>
					</tr>
